...
function Footer() {
    return (
        <footer className="footer">
            ...
            <a href="https://www.instagram.com/mr.hatter.photo/" target="_blank" rel="noreferrer">{instagramSVG}</a>
            <a href="https://www.facebook.com/KarpinchikAlexey/" target="_blank" rel="noreferrer">{facebookSVG}</a>
            <a href="https://t.me/MisterHatter" target="_blank" rel="noreferrer">{telegramSVG}</a>
        </footer>
    );
}
